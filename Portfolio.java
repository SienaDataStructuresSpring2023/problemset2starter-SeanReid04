...
/**
 * 
 * This class creates a Portfolio object along with methods in order to manipulate the object in a desired manner.
 *
 * @author Sean Reid.
 * @version Spring 2023.
 */
public class Portfolio
{
     ...
     */
    private int getIndex(String symbol){//while loop
    ...
    public double getCurrentValue(){
        double currentV = 0;
        for (int i =0; i < stocks.size(); i++){
            double numS = stocks.get(i).getNumShares();
